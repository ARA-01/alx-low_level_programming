...
In this project, I practiced creating my own Makefiles.
...
* [m.h](./m.h): Header file that defines the function prototype used in `school.c`.
...
* **5. Island Perimeter**
  ...
  * The parameter `grid` is a list of integers.
