 ...
 * @file: The title of the file buffer is storing characters for.
 *
...
/**
 * close_file - the function closes the file descriptors.
 ...
 * @argc: The number of arguments supplied in the function.
